...
<body>
    ...
    <main id="main">
    	<c:forEach var="clock" items="${clockList}">
	        <div class="section" id="clock01" style="background-image:url('upload_clock/${clock.realClockImg}')">
	            <div class="info">
	                <p class="category" data-splitting>${clock.category}</p>
